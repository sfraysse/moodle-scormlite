 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_passed extends attempt_statement {
     ...
     */
    protected $contextprops = ['masteryscore', 'maxtime'];
     ...
     */
    protected $resultprops = ['completion', 'score', 'duration'];
    ...
    protected function statement() {
        ...
        return array_replace($this->statement_base(), [
            ...
            'result' => $this->statement_result(true),
        ]);
    }
