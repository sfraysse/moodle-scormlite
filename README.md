> **ScormLite 3.4.x** est un plugin pour Moodle 3.4 permettant de déployer et suivre des activités SCORM simplifiées, conformes aux principes de SCORM Lite (cf http://scormlite.com).
